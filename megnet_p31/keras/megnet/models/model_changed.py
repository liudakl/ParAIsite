...
class MEGNetModel_Embed(GraphModel):
...
### =========== Output Dense layer with size 16 =========== #######    

class MEGNetModel_D4(GraphModel):
    """
